...
import { Users, ShieldCheck, FileQuestion, AlertTriangle, Headphones, Database, Settings } from "lucide-react"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, BarChart, Bar } from "recharts"
import { Skeleton } from "@/components/ui/skeleton"

export default function GlobalDashboardPage() {
  const { stats, recentActivity, userGrowthData, loading } = useDashboardStats()
      ...
      <div>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <ActionCard
            ...
            icon={Users}
            stats={loading ? "..." : `${stats.totalUsers.toLocaleString("id-ID")} users`}
          />
          <ActionCard
            title="Master Data"
            ...
            href="/master"
            icon={Database}
            stats={loading ? "..." : `${stats.totalQuizzes.toLocaleString("id-ID")} quizzes`}
          />
