        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex flex-wrap gap-6">
            {quiz.creator && (
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-foreground font-medium text-sm">{quiz.creator.fullname}</p>
            ...
            <div className="space-y-1">
              ...
              <p className="text-foreground font-medium capitalize">{quiz.category ?? "-"}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm text-muted-foreground">Language</p>
              <p className="text-foreground font-medium uppercase">{quiz.language ?? "ID"}</p>
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <p className="text-foreground font-medium">
                {quiz.created_at ? format(new Date(quiz.created_at), "dd MMM yyyy, HH:mm") : "-"}
              </p>
            </div>
          </div>
        </div>
                  ...
                  {options.length > 0 && (
                    <div className="pl-11 space-y-2">
                      {options.map((option, optIndex: number) => {
                        ...
                        const isCorrect = correctAnswerValue === optIndex || correctAnswerValue === optionId
